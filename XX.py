...
file_paths = ['/Users/simonlavalle/Downloads/b-data/ADAUSDT_1min_data.csv', '/Users/simonlavalle/Downloads/b-data/ADAUSDT_15min_data.csv', '/Users/simonlavalle/Downloads/b-data/ADAUSDT_1h_data.csv']
param_grid = {
    'target_percent': [0.03, 0.06, 0.1],
    'interval_step': [2],
...
results = grid_search(file_paths, '2024-01-01', '2024-08-01', param_grid)
save_results_to_csv(results, 'trading_strategy_results.csv')
# other time intervalls: '/Users/simonlavalle/Downloads/b-data/ADAUSDT_1min_data.csv', '/Users/simonlavalle/Downloads/b-data/ADAUSDT_1h_data.csv'